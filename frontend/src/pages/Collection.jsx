...
const Collection = () => {
  ...
  console.log("Collection.jsx products:", products);
...
const Collection = () => {
  ...
  console.log("Collection.jsx products:", products);
  console.log("Collection.jsx products length:", products.length);
  console.log("Collection.jsx products type:", typeof products);
  ...
  const applyFilter = () => {
     ...
     console.log("applyFilter called, products:", products); // Debug log
    console.log("Selected categories:", category); // Debug log
    console.log("Selected subcategories:", subCategory); // Debug log
    let productsCopy = products.slice();
    ...
    console.log("Filtered products:", productsCopy); // Debug log
    setFilterProducts(productsCopy)
  }
  ...
  useEffect(()=>{
    console.log("useEffect triggered - applyFilter"); // Debug log
    applyFilter();
  }, [category, subCategory, search, showSearch, products])
  ...
  const applyFilter = () => {
    ...
    if(subcategory.length > 0){
      productsCopy = productsCopy.filter(item => {
        return subcategory.includes(item.subCategory); // Fixed: using subCategory instead of subcategory
      });
    }
